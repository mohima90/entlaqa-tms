...
import {
  Shield, Building2, Users, Settings, CreditCard, BarChart3,
  FileText, Activity, Bell, Search, LogOut, ChevronDown,
  Globe, Database, Mail, AlertTriangle, Home
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-900 flex">
      <aside className="w-64 bg-slate-800 border-r border-slate-700 flex flex-col">
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-3">
          ...
          <ul className="space-y-1">
            <li>
              <Link
                href="/dashboard"
                className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-300 hover:bg-slate-700 hover:text-white transition-all"
              >
        ...
        <div className="border-t border-slate-700 p-4">
          ...
          <button
            onClick={() => signOut()}
            className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-slate-700 hover:bg-slate-600 rounded-lg text-slate-300 text-sm transition-all"
          >
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-80 pl-10 pr-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 text-sm focus:ring-2 focus:ring-red-500 focus:border-transparent"
              />
            </div>
          </div>
          <div className="flex items-center gap-4">
